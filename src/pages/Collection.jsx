...
export default function Collection() {
  ...
  const handlePrintReceipt = (txn) => {
    ...
    const receiptAcc = accounts.find(a => a.accNo === receiptAccountNo);
    const customerName = receiptAcc ? (receiptAcc.customer?.name || receiptAcc.name || 'N/A') : 'N/A';

    const html = `
      <html>
        <head>
          <title>Receipt - ${txn.refNo}</title>
          <style>
            @page {
              size: A4 portrait;
              margin: 15mm;
          ...
          <div class="receipt-container">
              ...
              <tr>
                <td>
                  <div class="info-item">
                    ...
                    <span class="info-value">${txn.refNo}</span>
                  </div>
                </td>
                <td>
                  <div class="info-item">
                ...
                <td>
                  <div class="info-item">
                    ...
                    <span class="info-value">${receiptAccountNo || 'N/A'}</span>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="info-item">
                    ...
                    <span class="info-value">${txn.collector}</span>
                  </div>
                </td>
                <td>
                  <div class="info-item">
            ...
            <div class="table-section">
              <table class="receipt-table">
                ...
                <tbody>
                  <tr>
                    <td>Daily collection received toward account ${receiptAccountNo || 'N/A'}</td>
                    <td class="text-right">₹${Number(txn.amt).toLocaleString('en-IN')}</td>
                    <td class="text-right">₹${Number(txn.fine).toLocaleString('en-IN')}</td>
                    <td class="text-right font-bold text-right">₹${Number(txn.amt + txn.fine).toLocaleString('en-IN')}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="bg-white rounded-2xl max-w-sm w-full p-6 shadow-2xl relative z-10 border border-[#E2E8F0] text-[#0F172A] font-sans flex flex-col gap-4 animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 mt-2">
                <button
                  onClick={() => handlePrintReceipt(receiptTxn)}
